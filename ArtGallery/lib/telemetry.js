...
(function (window) {
  ...
  function setupAnalytics() {
    ...
    injectScript(
      "https://www.googletagmanager.com/gtag/js?id=" + MOZILLA_RESEARCH_TRACKER,
      function (err) {
        if (err) {
  ...
  function setupErrorLogging() {
    ...
    injectScript(
      "https://cdn.ravenjs.com/3.22.3/console/raven.min.js",
      function (err) {
        if (err) {
    ...
    function startRaven() {
      Raven.config(
        "https://816fbc92b9e14534b3a8b6a04f075140@sentry.prod.mozaws.net/371"
      ).install();
    }
  }
